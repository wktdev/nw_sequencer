...
$(function() {
    ...
    var kick = audioFileLoader("sounds/kick.ogg");
    var snare = audioFileLoader("sounds/snare.ogg");
    var hihat = audioFileLoader("sounds/hihat.ogg");
    var shaker = audioFileLoader("sounds/shaker.ogg");
